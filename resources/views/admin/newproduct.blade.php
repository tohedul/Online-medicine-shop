...
<html>
<head>
	<title>Mew Medicine| customer</title>
    ...
    <div class="container">
      ...
      <form method="post">
        ...
        <table border="1">
          ...
          <tr>
            <td>Genre: </td>
            <td><input type="text" name="genre" value="" required> </td>

          </tr>
          <tr>
            <td>Form of med: </td>
            <td><input type="text" name="form" value="" required> </td>

          </tr>
          <tr>
            <td>Vendor name: </td>
            <td><input type="text" name="vendor" value="" required> </td>
